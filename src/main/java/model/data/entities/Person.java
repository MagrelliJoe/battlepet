...
public class Person {
            ...
            switch (pet.getType()) {
                case BIRD:
                    ...
                    switch (pet.getLevels()) {
                        ...
                        case ULTRA:
                            pet.getAttackSet().remove(0);
                            pet.getAttackSet().add(new Attack(Attack.perforbecco));
                            break;
                        case PERFECT:
                            pet.getAttackSet().remove(1);
                ...
                case CAT:
                    ...
                    switch (pet.getLevels()) {
                        ...
                        case ULTRA:
                            pet.getAttackSet().remove(0);
                            pet.getAttackSet().add(new Attack(Attack.pallaDiPelo));
                            break;
                        case PERFECT:
                            pet.getAttackSet().remove(1);
                ...
                case DOG:
                    ...
                    switch (pet.getLevels()) {
                        ...
                        case ULTRA:
                            pet.getAttackSet().remove(0);
                            pet.getAttackSet().add(new Attack(Attack.ipermorso));
                            break;
                        case PERFECT:
                            pet.getAttackSet().remove(1);
    ...
    public void addPetWithoutTrainerLevel(Integer key ,Pet pet,Levels levels) {
        pet.setLevels(levels);
        if(pet.getAttackSet().size()==0) {
            switch (pet.getType()) {
                case BIRD:
                    pet.getAttackSet().add(Attack.beccata);
